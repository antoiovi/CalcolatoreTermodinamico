...
public class APanelTubo_in extends JPanel implements ActionListener, APTubo {
	...
	public APanelTubo_in() {
		...
		springLayout.putConstraint(SpringLayout.SOUTH, panel_1, 300, SpringLayout.NORTH, this);
		springLayout.putConstraint(SpringLayout.EAST, panel_1, 116, SpringLayout.WEST, this);

		this.add(panel_1);
		forma = "Circolare";
		
				textLatoA = new JSpinner();
				textLatoA.setToolTipText("Lato A [cm]");
				...
				panel_1.add(comboBoxSezione);
						...
						textDiametro.setToolTipText("Diametro interno[ cm]");
				...
				panel_1.add(textLatoA);
						...
						textLatoB.setToolTipText("Lato B [cm]");
				...
				DecimalFormat df=ne.getFormat();
						...
						textRugosita.setToolTipText("Rugosit\u00E0: Click dx per help\r\n");
						panel_1.add(textRugosita);
						textRugosita.setColumns(10);
						
						textRugosita.setInputVerifier(verifier);
						textRugosita.getDocument().addDocumentListener(new DocumentListener() {
							  public void changedUpdate(DocumentEvent e) {
							    CreaTubo();
							    textRugosita.requestFocusInWindow();
								  //warn();
							  }
...
//								  	warn();
						...
						textResterm.setToolTipText("Resistenza termica: click dx per help");
				...
				panel_1.add(txtLungh);
						...
						textField.setBackground(UIManager.getColor("FormattedTextField.disabledBackground"));
						textField.setEditable(false);
						panel_1.add(textField);
						textField.setColumns(10);
				
						textField_1 = new JTextField();
						textField_1.setBackground(UIManager.getColor("FormattedTextField.disabledBackground"));
						textField_1.setEditable(false);
						panel_1.add(textField_1);
						textField_1.setColumns(10);
				textField_2.setBackground(UIManager.getColor("FormattedTextField.disabledBackground"));
				textField_2.setEditable(false);
				panel_1.add(textField_2);
				textField_2.setColumns(10);
				
						textField_3 = new JTextField();
						textField_3.setBackground(UIManager.getColor("FormattedTextField.disabledBackground"));
						textField_3.setEditable(false);
						panel_1.add(textField_3);
						textField_3.setColumns(10);
		
				textField_4 = new JTextField();
				textField_4.setBackground(UIManager.getColor("FormattedTextField.disabledBackground"));
				textField_4.setEditable(false);
				panel_1.add(textField_4);
				textField_4.setColumns(10);
		
				textField_5 = new JTextField();
				textField_5.setBackground(UIManager.getColor("FormattedTextField.disabledBackground"));
...
/**
 * INS4ERISCE I MENU POPUP PER I COMPONENTI CHE NE HANNO UNO
 * @param component
 * @param popup
 */
...
/**
 * ActionPerformed : intercetta i comandi dei menupopup, e i cambiamenti del combo box
 */
	@Override
...
/**
 * Imposta i campi in base ad un tubo
 */
	@Override
	public void setTubo(Tubo tub) {
		...
		/**
		 * Imposta i valori dei campi da calcolare
		 * */
			setValues();
	...
	/**
	 * Imposta i valori dei cam'i non editabili , ma da calcolare 
	 */
...
/**
 * CREA un tubo se i campi di input sono validi
 */
	...
	/**
	 * Impsoto i campi da calcolare ad un valore di errore...
	 * @param s
	 */
...
private boolean verifica(){
	try{
		...
		diametro =(Double)textDiametro.getModel().getValue()/1000;
		latoa = (Double)textLatoA.getModel().getValue()/1000;
		latob = (Double)textLatoB.getModel().getValue()/1000;
		lungh= (Double)txtLungh.getModel().getValue();
