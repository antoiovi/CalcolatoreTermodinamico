...
/**
 * Permette l'inserimento di un tubo non concentrico 
 * @author antoiovi
 *
 */
public class APanelTubo_2 extends JPanel implements ActionListener, APTubo {
	...
	public APanelTubo_2() {
		...
		circolare();
		tubo = TuboFactory.getInstace().TuboC(0.100,
				0.105, 100, 0.001, 1);
	this.setTubo(tubo);
	}
	...
	private void CreaTubo() {
		/**
		 * Chiama verifica() : vengono trasformati i dati input in numeri, e convertiti in m
		 */
		if(!verifica()){
			setoutString("Err");
			return ;
